	...
	template: 
		...
		<div class="container index-title">
			...
			<div class="row flex-column-reverse flex-md-row">
				<div class="col-md-5">
					<div id="portrait-container" style="width:100%">
						<img src="/portrait.jpg" width="275" class="pretty-img">
					</div>
				</div>
				<div class="col-md-7">
					<h1 class="display-6 accent">About Me</h1>
					<p style="font-size:75%" class="mb-0">
			...
			<div class="row">
				<div class="col">
					<p style="font-size:75%;padding: 0px 10%">
